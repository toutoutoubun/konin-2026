...
const updates = [
  ...
  ['2026-05-13', '地学基礎', '地学基礎PDFの端末内分析を追加。文部科学省の過去問大問見出しに合わせ、頻出分野、年度別推移、大問構成、出題形式を表示。', '地学基礎分析ページ・タグ定義ページ'],
  ['2026-05-13', '生物基礎', '生物基礎PDFの端末内分析を追加。文部科学省の過去問大問見出しに合わせ、頻出分野、年度別推移、大問構成、出題形式を表示。', '生物基礎分析ページ・タグ定義ページ'],
  ['2026-05-13', '化学基礎', '化学基礎PDFの端末内分析を追加。文部科学省の過去問大問見出しに合わせ、頻出分野、年度別推移、大問構成、出題形式を表示。', '化学基礎分析ページ・タグ定義ページ'],
  ...
  ['2026-05-12', '免除確認', '文部科学省HPをもとに、既取得単位による免除申請の流れと単位修得証明書の準備手順を追加。', '出願Todo・免除科目確認'],
  ['2026-05-12', '免除確認', '文部科学省の技能審査免除一覧PDFに合わせ、歴検・数検・英検等・ITパスポートによる免除チェックとTodoを追加。', '免除申請チェックリスト・出願Todo'],

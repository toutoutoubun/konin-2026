...
export const toolPages: ToolPage[] = [
  ...
  },
  {
    ...
    description:
      '文部科学省の免除要件を確認しながら、高校・高専の単位修得証明書、英検・数検・歴検・ITパスポートなどの技能審査、受験が必要な可能性のある科目を並べます。確定判定ではなく、出願前に公式書類と照合するための下書きとして使います。',
    cta: '免除を確認する',
    accent: 'yellow',
    highlights: [
      '高校・高専の入学時期別の単位免除要件を確認する前提で整理',
      '技能審査による免除対象を入力欄に反映',
      '免除申請チェックリストで、証明書類の準備状況を確認する',
    ],
    bestFor: [
  ...
  },
  {
    ...
    title: '公式過去問PDF傾向分析',
    summary: '文部科学省公式過去問PDFを端末内で解析し、科目ごとの頻出単元や年度推移を可視化します。',
    description:
      'ユーザー自身が取得した公式過去問PDFをブラウザ内で読み取り、問題文や設問文を保存・再掲載せずに、出題傾向データだけを集計します。英語、数学、歴史、地理、科学と人間生活、物理基礎など、実装済み科目の分析ページへ移動できます。',
    cta: '分析科目を選ぶ',
    accent: 'blue',
    highlights: [

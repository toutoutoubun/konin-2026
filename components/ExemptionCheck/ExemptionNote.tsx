  ...
  return (
    <aside className="mt-4 border-2 border-ink/20 bg-cream p-3 sm:p-4" aria-label="免除確認に関する注意事項">
      ...
      <ol className="mt-2 list-decimal space-y-1.5 pl-5 text-sm leading-relaxed">
        <li>単位で申請する場合は、高校または高専のどちらで単位を修得したかと、入学時期を確認します。</li>
        <li>入学時期ごとの表で、免除を受けたい試験科目に対応する高校科目・高専科目と必要単位数を確認します。</li>
        ...
        <li>高専で平成15年4月より前に入学した場合は、この表では判定せず文部科学省へ確認します。</li>
      ...
      <div className="mt-3 flex flex-wrap gap-2 text-sm">
        ...
        <a href={officialKosenCreditExemptionUrl} target="_blank" rel="noopener" className="font-bold">
          高専単位免除要件
        </a>

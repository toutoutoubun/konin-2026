...
const tagsBySubject: Record<string, TagDef[]> = {
  ...
  civics: [
    ['UNIT-CONST', '日本国憲法', '憲法の条文・基本原理・人権に関する問題', '日本国憲法の条文・判例・原理を問う場合に付与', '基本的人権、三権分立、違憲審査'],
    ['UNIT-MARKET', '市場経済', '市場メカニズム・経済理論に関する問題', '需給・価格・景気など経済の仕組みを問う場合に付与', '需要と供給、GDP、金融政策'],
    ['UNIT-INTL', '国際政治', '国際関係・国際機構に関する問題', '国際連合・条約・国際紛争を扱う場合に付与', '国連の仕組み、安全保障、国際条約'],
    ['UNIT-WELFARE', '社会保障', '社会保障制度・福祉政策に関する問題', '年金・医療・介護など社会保障制度を問う場合に付与', '公的年金、医療保険、少子高齢化対策'],
    ['UNIT-ETHICS', '倫理思想', '東西の倫理思想・哲学に関する問題', '思想家・哲学・宗教の思想を問う場合に付与', 'ソクラテス、儒教思想、功利主義'],
  ],
  'science-life': [
    ...
    children: `
      ...
      <section class="content-section" aria-labelledby="common-tag-title">
        ...
        <div class="note-box">
          ...
          <p>制度区分タグ：新課程・旧課程の区分は科目詳細ページのフィルタで選択できます。歴史・地理・公民には旧課程のサブ区分（例：日本史A、日本史B）が含まれます。</p>
        </div>
      </section>`
  })
}
